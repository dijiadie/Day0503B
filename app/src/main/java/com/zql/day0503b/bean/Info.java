...
@Id
        ...
        private int visible;
        private int zan;
        @Generated(hash = 790769761)
        public Info(Long db_Id, String apkLink, int audit, String author,
                ...
                boolean fresh, int id, String link, String niceDate,
